...
// Load GeoJSON data
loadGeoJSON('geojs/Linea1_20250702.geojson', layers.polyline1, styles.polyline1, 'TRAMO', 'polyline');
loadGeoJSON('geojs/Linea2.geojson', layers.polyline2, styles.polyline2, 'TRAMO', 'polyline');
loadGeoJSON('geojs/Linea3.geojson', layers.polyline3, styles.polyline3, 'TRAMO', 'polyline');
loadGeoJSON('geojs/Linea4_20250702.geojson', layers.polyline4, styles.polyline4, 'TRAMO', 'polyline');
loadGeoJSON('geojs/Linea5_NT.geojson', layers.polyline5, styles.polyline5, 'TRAMO', 'polyline');
loadGeoJSON('geojs/Linea6_NT.geojson', layers.polyline6, styles.polyline6, 'TRAMO', 'polyline');
